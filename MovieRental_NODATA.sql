...
CREATE TABLE `movie` (
  ...
  `LEADINGACTOR` varchar(100) DEFAULT NULL,
  `STUDIO` varchar(100) DEFAULT NULL,
  `DIRECTOR` varchar(100) DEFAULT NULL,
  `LENGTH` double DEFAULT NULL,
  `RENTALPRICE` double NOT NULL,
  `COSTPRODUCTION` double DEFAULT NULL,
  `ESTIMATEDBOXOFFICEREVENUE` double DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mruser`
--

DROP TABLE IF EXISTS `mruser`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mruser` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `order_details` (
  ...
  CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`ID`)
...
CREATE TABLE `orders` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mruser` (`id`)
...
CREATE TABLE `shoppingcart` (
  ...
  KEY `user_id` (`user_id`),
  KEY `movie_id` (`movie_id`),
  CONSTRAINT `shoppingcart_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mruser` (`id`),
  CONSTRAINT `shoppingcart_ibfk_2` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`ID`)
...
-- Dump completed on 2023-12-04 23:55:08
